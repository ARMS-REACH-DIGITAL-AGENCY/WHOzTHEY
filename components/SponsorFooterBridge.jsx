...
export default function SponsorFooterBridge() {
  ...
  return (
    <>
      {selectedSponsor && (
        <section style={{ position: 'fixed', top: 112, left: 0, right: 0, bottom: 0, zIndex: 90, overflow: 'hidden', background: '#fff', borderTop: '3px solid #e2e8f0', boxShadow: '0 8px 24px rgba(15,23,42,0.18)' }}>
          <iframe
