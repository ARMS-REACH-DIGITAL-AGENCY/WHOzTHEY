  ...
  return (
    <footer style={{ background:"#0f172a", position:"sticky", bottom:0, zIndex:40, boxShadow:"0 -4px 16px rgba(0,0,0,0.5)" }}>
      <div style={{ maxWidth:"760px", margin:"0 auto" }}>
        ...
        <button onClick={openItem} style={{ width:"100%", background:"#1e293b", border:"none", borderRadius:"0", padding:"10px 14px", display:"flex", alignItems:"center", gap:"10px", cursor:"pointer", textAlign:"left" }}>
          <div style={{ flex:1, minWidth:0 }}>
            ...
            {item.isSponsor && (
              <p style={{ fontFamily:"system-ui", fontSize:"10px", color:"#94a3b8", margin:"3px 0 0", letterSpacing:"0.08em", textTransform:"uppercase", fontWeight:"700" }}>
                Tap WHOzTHEY? to view this sponsor offer
              </p>
            )}
          </div>
...
function Hero({ onSearch, loading, persona, user, onLoginRequest, onQuizRequest, onStoreClick }) {
  ...
  return (
    <header style={{ background:"#0f172a", position:"sticky", top:0, zIndex:100, boxShadow:"0 2px 12px rgba(0,0,0,0.5)" }}>
      ...
      {/* Row 2: They say + search input + logo button */}
      <div style={{ padding:"8px 16px 10px" }}>
        <p style={{ fontFamily:"'Georgia',serif", fontSize:"13px", fontWeight:"700", color:"#dc2626", margin:"0 0 5px", letterSpacing:"0.02em" }}>They say…</p>
